...
个人账号与外部任务协作不属于任何企业租户，使用独立的 `/collaboration` 路由组；账号设置统一使用 `/account`。当前任务授权可按仓库划分范围，但入口不绑定某一种任务类型。
...
| `/collaboration`            | 个人账号下的外部合作关系与长期发展入口   | 独立个人协作导航  |
| `/collaboration/tasks`      | 外部任务收件箱；卡片展示订单发货等具体类型 | 独立个人协作导航  |
| `/account`                  | 与企业无关的个人账号资料与密码           | 个人协作/ERP 共用 |
