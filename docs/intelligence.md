...
商品情报的外部采集不采用“后台抓取 URL 后直接创建 SKU”的方式。Apple 分享入口、Chrome/Safari 扩展和 ERP Web 粘贴链接统一写入采集箱；来源商品、来源快照和价格观察与标准商品组/SKU 分层保存。

详细方案：

- [商品情报采集系统](product-intelligence-capture/README.md)
- [产品需求文档](product-intelligence-capture/PRODUCT_SPEC.md)
- [技术架构](product-intelligence-capture/TECHNICAL_ARCHITECTURE.md)
- [实施计划](product-intelligence-capture/IMPLEMENTATION_PLAN.md)
